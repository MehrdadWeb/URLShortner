...
$(document).ready(function(){
        ...
        $("#switch1").click(function(){
                if($("body").hasClass('firstbg'))
                {
                    ...
                    $("#moon").attr("src","/images/sun.png");
                    $("#button1").css("background-image","url(http://mehrdadweb.ir/images/bglinkshortener.png)");
...
<div class="row mx-0 rwo_767_576"><!-- mx-0 طلایی -->  
    ...
    <div class="col-sm-10 px-0"><!-- px-0 طلایی -->
        ...
        <div style="">
            ...
            ?>
            <div class="box8 box9" id="id07" onclick="javascript:window.location='http://mehrdadweb.ir/login/logout.php'">
        ...
        <div class="thirdarticle1 mt-2 mx-auto" dir="rtl">
            ...
            <div class="box6 mb-1 mx-auto" id="switch3" style="width:32px;height:32px;background-color: #f8f9fa;">
                <img style="width:32px;height:32px" class="moon_sun" src="/images/moon.png" id="moon">
            </div>  
        </div>
