...
if($nowtime < $bu && $datetimeObj1 == $datetimeObj2){
    ...
    echo  "TIME = ".$date1." /BannedUntil= ".$row['datebu']." ".$row['bu']."<br>(3.)you have entered password 3 times  and you are blocked until 1 hour(".$row['datebu']." ".$row['bu'].")";
    $_SESSION['count'] = 0;
    exit();
}
...
//. چک میکنیم که کاربر 3 بار رمز را اشتباه وارد کرده یا نه    
    if($_SESSION['count'] == 2){
        ...
        echo "<br>TIME = ".$date1."<br>(2.)!!! wrong password 3 times and you cannot login until ".$row3['datebu']." ".$row3['bu'].".3";
        exit();
    ...
    echo "d=".$date1." / <br>(1.)!!! wrong password ".$_SESSION['count'];
    exit();
...
<html>
<head>
        <!--<link rel="stylesheet" href="http://mehrdadweb.ir/shortlink/shortlinker.css">
    <link rel="stylesheet" type="text/css" href="http://mehrdadweb.ir/css/mainshortlinker.css">-->
